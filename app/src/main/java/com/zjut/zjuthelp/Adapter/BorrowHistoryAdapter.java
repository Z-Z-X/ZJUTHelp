...
public class BorrowHistoryAdapter extends RecyclerView.Adapter<BorrowHistoryAdapter.ViewHolder> {
    ...
    public BorrowHistoryAdapter(Context context, List<Book> list) {
        mList = list;
        mContext = context;
    }
    ...
    public void onBindViewHolder(ViewHolder viewHolder, int i) {
        ...
        viewHolder.bookReturnTime.setText("归还时间: " + book.getBookReturntime());
    }

    @Override
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View v = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.item_borrow_history, viewGroup, false);
